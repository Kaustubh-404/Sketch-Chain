...
//       <h1 className="text-4xl font-bold mb-8">Web3 Scribble</h1>
//       {!address ? (
//        <ConnectButton />
//       ) : (
...
//             className="block w-full px-6 py-3 bg-blue-500 text-white rounded"
//           >
//             Create Room
//           </button>
//           <button
//             onClick={() => router.push('/join')}
//             className="block w-full px-6 py-3 bg-green-500 text-white rounded"
//           >
//             Join Room
//           </button>
//           <button
//             onClick={() => router.push('/history')}
//             className="block w-full px-6 py-3 bg-gray-500 text-white rounded"
//           >
//             Game History
//           </button>
//         </div>
